<template>
    <div class="dashboard-container">
        ...
        <el-row style="margin-top: 20px;" :gutter="20">
            ...
            <el-col :span="12">
                <el-card v-if="aiData.consultationStats && aiData.systemOverview" style="width: 100%;">
                    <template #header>
                        <div class="card-header">
                            咨询会话统计
                        </div>
                    </template>
                    <div class="chart-content consultation-content">
...
const initConsultationCharts = () => {
    ...
    const chart = echarts.init(consultationChartRef.value)
