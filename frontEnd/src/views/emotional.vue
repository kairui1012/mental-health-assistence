<template>
    <div>
        ...
        <el-pagination v-model:current-page="pagination.currentPage" style="margin-top: 25px;"
            :page-size="pagination.size" layout="prev, pager, next" :total="pagination.total"
        ...
        <el-dialog v-model="detailDialogVisible" title="情绪日志详情" width="800px" :close-on-click-modal="false"
            ...
            <div v-if="currentDetail && currentDetail.hasAiEmotionAnalysis" class="detail-section">
                <h4>AI情绪分析结果</h4>
